...
class BuscaSeguradoraService extends base_service_1.BaseService {
    ...
    getSeguradora(seguradoraId) {
        return __awaiter(this, void 0, void 0, function* () {
            const seguradora = yield this.findById(seguradoraId);
            return seguradora;
        });
    }
}
exports.BuscaSeguradoraService = BuscaSeguradoraService;
//# sourceMappingURL=busca-seguradora.service.js.map